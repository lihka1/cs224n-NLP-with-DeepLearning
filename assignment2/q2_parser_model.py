...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        with tf.variable_scope("one_hidden_layer"):
            W = (xavier_weight_init()(((self.config.n_features*self.config.embed_size,
                                                self.config.hidden_size))))
            b1 = tf.Variable(tf.zeros((self.config.hidden_size,),dtype=tf.float32))
            U = (xavier_weight_init()(((self.config.hidden_size,
